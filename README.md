...
Preprocessing allows you to extend the capabilities of CSS.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

Mixins are my favorite concept. I’d say I have the most trouble with inheritance.
...
A function organizes multiple instructions into a single code that would otherwise take many more steps. Functions are reusable and it’s simple to make alterations as need be.
